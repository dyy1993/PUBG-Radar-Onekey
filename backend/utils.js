...
const classNameMap = {
  ...
  'Weapon': {
    ...
    'SCAR-L':                 ['SC', 0b00000000000000010000000000000000],
    'AK47':                   ['AK',   0b00000000000000001000000000000000],
    'Kar98k':                 ['98K狙击',   0b00000000000000000100000000000000],
  ...
  'Ammo': {
    //'9mm': '.9',
    //'45mm': '.45',
    '556mm':                  ['.56',   0b00000000000000000000010000000000],
    '762mm':                  ['.76',   0b00000000000000000000001000000000],
    //'300mm': '.3',
  },
  'Armor': {
    'C': { '01': { 'Lv3':     ['三级甲',     0b00000000000000000000000010000000]} },
